                    ...
                    <div class="container-fluid px-4">
						...
						$conn = new mysqli("localhost","root","","janata");
                                        ...
                                        <tr>
                                            ...
                                            <td><center><img src="image/edit.png" height="50" width="50" onClick="location.href='editstores.php?aid=<?php echo $store_id ?>';"></center></td>
                                            <td><center><img src="image/delete.png" height="50" width="50" onClick="location.href='deletestores.php?aid=<?php echo $store_id ?>';"></center></td>
                                        </tr>
                                        <?php }} ?>
                                    </tbody>
                                </table>

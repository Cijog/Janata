                    ...
                    <div class="container-fluid px-4">
						...
						$conn = new mysqli("localhost","root","","janata");
                                        ...
                                        <tr>
                                            ...
                                            <td><center><img src="image/ok.jpg" height="50" width="50" onClick="location.href='acceptuser.php?aid=<?php echo $id ?>';"></center></td>
                                            <td><center><img src="image/cancel.jpg" height="50" width="50" onClick="location.href='rejectuser.php?aid=<?php echo $id ?>';"></center></td>
                                        </tr>
                                        <?php }} ?>
                                    </tbody>
                                </table>

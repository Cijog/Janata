             ...
             <main>
                    ...
                    <div class="container-fluid px-4">
						...
						$conn = new mysqli("localhost","root","","janata");
                                        ...
                                        $sql = "SELECT * FROM topup where not status=1 ";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $date;?></td>
                                            <td><center><img src="image/accept1.png" height="50" width="50" onClick="location.href='accept.php?aid=<?php echo $id ?>';"></center></td>
                                            <td><center><img src="image/completed1.png" height="50" width="50" onClick="location.href='complete.php?aid=<?php echo $id ?>';"></center></td>

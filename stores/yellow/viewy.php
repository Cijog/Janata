                                ...
                                while($row = $result->fetch_assoc()) {	
                                    ...
                                    if($result_catname->num_rows > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="/janatac/stores/yellow/img/<?php echo $image; ?>" height="25" width="25"></td>
                                            <td><label class="<?php echo $class; ?>"><?php echo $stat;?></label></td>
                                            <td><img src="img/edit.png" height="25" width="25" onClick="location.href='edity.php?eid=<?php echo $id;?>';"></td>
                                            <td><img src="img/delete.png" height="25" width="25" onClick="location.href='deletey.php?id=<?php echo $id;?> ';"></td>
                                        </tr>
                                    <?php }
                                }
                            }?>

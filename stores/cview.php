...
<html lang="en">
  ...
  <div class="content-wrapper pb-0">
    <!-- BODY STARTS -->
    <div align="right">
      <input type="button" class="button" value="Add" name="add" onClick="location.href='new.php';" />
    </div>
    <br>
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title" align="center">Category</h4>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><img src="img/edit.png" height="25" width="25" onClick="location.href='cedit.php?id=<?php echo $id; ?>';"></td>
                        <td><img src="img/delete.png" height="25" width="25" onClick="location.href='cdelete.php?id=<?php echo $id; ?>';"></td>
                      </tr>
                  <?php
                    }
                  }

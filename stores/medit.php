...
if(isset($_GET['eid']))
{
    ...
    if($result->num_rows>0)
    {
      ...
      $oldPath="$Root/janatac/store/img/$oldImage";
    }
    ...
    {   
      ...
      if(!empty ($_FILES['file']['name'] ))
      {
        ...
        $targetPath = $Root."/janatac/store/img/";
        ...
        if(unlink($oldPath))
        {
          ...
          {
            $sql = "update products set catid = '1',products = '$productName',quantity ='$quantity', price ='$price', image = '$fileName',status = '$status',  where id = '$id'";
            $result = $conn->query($sql);
          }
        }
      ...
      {  
        ...
        $sql = "update products set catid='1',products = '$productName', quantity ='$quantity', price ='$price',status = '$status' where id = '$id'";
        $result = $conn->query($sql);
        ...
        <div class="card-body">
          ...
          <form name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <img src="/janatac/store/img/" width="50" height="50" />
            </div>
            <div class="form-group">

...
$pdtame = $_POST['product'];
$quantity = $_POST['quantity'];
$price = $_POST['price'];
$status= $_POST['status'];
$filename = $_FILES['file']['name'];
$target_path =  $Root."/janatac/stores/pink/img/";
...
$conn=new mysqli("localhost","root","","janata");
 ...
 $sql = "INSERT INTO products(catid,products,quantity,price,image,status)
VALUES( 4, '$pdtame','$quantity','$price','$filename','$status')";

if ($conn->query($sql) === TRUE) {
  $_SESSION['msg']="New record inserted successfully";
            ...
            <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description" align="center">Insert details</p>

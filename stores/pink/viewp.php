    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_nav">
          ...
          <div class="content-wrapper pb-0">
             ...
             <!--BODY STARTS-->
			 <div><input type="button" class="button" value="Add" name="add" onClick="location.href='new.php';"/></div>
             <br>
		...
		$class="badge bg-danger";
						...
						?>
                          <tr>
							...
							<td><img src="/janatac/stores/pink/img/<?php echo $image; ?>" height="25" width="25"></td>
							...
							<td><img src="img/edit.png" height="25" width="25" onClick="location.href='editp.php?eid=<?php echo $id;?>';"></td>
							<td><img src="img/delete.png" height="25" width="25" onClick="location.href='deletep.php?id=<?php echo $id;?> ';"></td>
                          </tr>

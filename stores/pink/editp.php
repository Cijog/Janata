...
if(isset($_GET['eid']))
{
    ...
    if($result->num_rows>0)
    {
      ...
      $oldPath="$Root/janatac/stores/pink/img/$oldImage";
    }
    ...
    {   
      ...
      if(!empty ($_FILES['file']['name'] ))
      {
        ...
        $targetPath = $Root."/janatac/stores/pink/img/";
        ...
        if(unlink($oldPath))
        {
          ...
          {
            $sql = "update products set catid = '4',products = '$productName',quantity ='$quantity', price ='$price', image = '$fileName',status = '$status',  where id = '$id'";
            $result = $conn->query($sql);
          }
        }
      ...
      {  
        ...
        $sql = "update products set catid='4',products = '$productName', quantity ='$quantity', price ='$price',status = '$status' where id = '$id'";
        $result = $conn->query($sql);
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="viewp.php">View Products</a>
                                            <a class="nav-link" href="addp.php">Add Products</a>                                           
                                        </nav>
                                    </div>
                                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#pagesCollapseAuth" aria-expanded="false" aria-controls="pagesCollapseAuth">
                                        Yellow Card
        ...
        <div class="card-body">
          ...
          <form name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <img src="/janatac/Admin/pink/img/"<?php echo $oldImage;?> width="50" height="50" />
            </div>
            <div class="form-group">

...
// Fetch partners based on the store_id
$sql = "SELECT * FROM partner WHERE store_id = ?";
            ...
            <?php if(isset($_SESSION['msg']))
             ...
             <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="text-end">
                            <a class="nav-link" href="add_partner.php">
                                    ...
                                    <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><center><img src="img/edit.png" height="50" width="50" onClick="location.href='editstores.php?aid=<?php echo $store_id ?>';"></center></td>
                                                    <td><center><img src="img/delete.png" height="50" width="50" onClick="location.href='deletestores.php?aid=<?php echo $store_id ?>';"></center></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>

...
$oldCategoryName = $row['ctgname'];
$oldCategoryStatus = $row['ctgstatus'];
}
if(isset($_POST['submit']))
    {
        $catname = $_POST['catname'];
        $status = $_POST['status'];
        $sql = "update tblcategories set ctgname = '$catname', ctgstatus = '$status' where id = '$id'";
        $result = $conn->query($sql);
        if($result)
        {
                  ...
                  <div class="card-body">
                    ...
                    <form name="myform" id="myform" method="post" action="">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="catname" id="catname" placeholder="Category Name" value="<?php echo $oldCategoryName; ?>" />
